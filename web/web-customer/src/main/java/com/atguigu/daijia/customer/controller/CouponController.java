...
public class CouponController {
    ...
    public Result<PageVo<NoReceiveCouponVo>> findNoReceivePage(
        ...
        return Result.ok(couponService.findNoReceivePage(customerId, page, limit));
    }
    ...
    public Result<PageVo<NoUseCouponVo>> findNoUsePage(
        ...
        Long customerId = AuthContextHolder.getUserId();
        return Result.ok(couponService.findNoUsePage(customerId, page, limit));
    }
    ...
    public Result<PageVo<UsedCouponVo>> findUsedPage(
        ...
        Long customerId = AuthContextHolder.getUserId();
        return Result.ok(couponService.findUsedPage(customerId, page, limit));
    }
