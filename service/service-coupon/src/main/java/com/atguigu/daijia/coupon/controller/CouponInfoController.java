...
public class CouponInfoController {
    ...
    public Result<PageVo<NoReceiveCouponVo>> findNoReceivePage(
        ...
        return Result.ok(couponInfoService.findNoReceivePage(customerId, page, limit));
    }

    @Operation(summary = "查询已领取未使用优惠券分页列表")
    ...
    public Result<PageVo<NoUseCouponVo>> findNoUsePage(
        ...
        return Result.ok(couponInfoService.findNoUsePage(customerId, page, limit));
    }

    @Operation(summary = "查询已领取已使用优惠券分页列表")
    ...
    public Result<PageVo<UsedCouponVo>> findUsedPage(
        ...
        return Result.ok(couponInfoService.findUsedPage(customerId, page, limit));
    }

    @Operation(summary = "领取优惠券")
    @GetMapping("/receive/{customerId}/{couponId}")
    public Result<Boolean> receiveCoupon(@PathVariable Long customerId, @PathVariable Long couponId) {
        return Result.ok(couponInfoService.receiveCoupon(customerId, couponId));
    }
